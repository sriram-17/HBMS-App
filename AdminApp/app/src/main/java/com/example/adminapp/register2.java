...
public class register2 extends AppCompatActivity {
    ...
    void insertData(){
        ...
        HospitalData hospitalData=new HospitalData(vHName,vemail,vpass,vphone,vaddress,vlatitude,vlongitude,downloadUrl);
        ...
        dbRef1.child("Ventilator").setValue(hospitalData4).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(register2.this,"Hospital Registered Successfully",Toast.LENGTH_SHORT).show();
                Intent intent1=new Intent(register2.this,login.class);
